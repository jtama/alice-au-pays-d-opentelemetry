...
[.notes]
--
Je relance mon collecteur et ...

Ah oui alors le receiver prometheus ne provient pas de la distribution _core_, il faut allez piocher dans le repo _contrib_. Il a donc fallu que je modifie mon déploiement pour que ça fonctionne...

__Pour que cela fonctionne j'ai juste ajouté la dépendance qui va bien à l'app quarkus.__
