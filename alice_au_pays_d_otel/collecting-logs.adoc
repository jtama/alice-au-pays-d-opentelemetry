...
[.notes]
--
Je ne vous refais pas le coup, il faut déployer un backend de collecte de log...
J'ai pris oki, qui a ses specificités.

Il y a eu une super conf hier sur Loki, si vous l'avez raté, elle sera dispo sur youtube.
--
...
Operator NoOp, oui mais non, pour du test, en tout cas, au moment ou j'ai essayé.
