...
[.notes]
--
Alors c'est génial, ça fonctionne, les traces et métrics sont collectées par les sidecars, qui les envoie au collecteur en chef, mais, parce qu'il faut toujours un mais...les attributs de mes metrics restent désespérément vide, je fais le shadock et je touche à tout en esperant que ça fonctionne, mais rien...
--
...
Du coup j'ai aussi activé le processor k8sAttributeProcessor sur le collecteur central pour récupérer le reste des metadata et annotation déja présent sur mes déploiement.
--
...
Ce que je fais par contre, c'est que j'active le k8sAttributeProcessor sur mon collecteur Maitre !
--
