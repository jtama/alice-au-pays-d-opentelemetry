...
Jamais vous vous diriez je vais je me mettre à exploiter un clluster kube mais sans lire la doc... Donc je vais lire la doc.
...
J'active la détection par variable d'environnement. Je fais tout le travail côté kube,  je ne vous lle met pas dans les slides mais je vous donnerais le lien vers un dépôt qui contient tout ce qu'il faut.
